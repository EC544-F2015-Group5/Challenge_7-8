...
io.on('connection', function(socket){
  ...
  if(msg == "F"){ // Go Forward
    gpio.open(10, "output", function(err) {		// Open pin 16 for output 
    gpio.write(10, 1, function() {			// Set pin 16 high (1) 
      gpio.close(10);						// Close pin 16 
    });
    });
    
  }else if(msg == 'B'){  // Go backward
  ...
  }else if(msg == 'S'){  // Stop the crawler 
  ...
  }else if(msg == 'C'){  // Calbrate the crawler
   gpio.open(24, "output", function(err) {		// Open pin 16 for output 
	gpio.write(24, 1, function() {			// Set pin 16 high (1) 
	gpio.close(24);						// Close pin 16 
	 });
  });
  }
